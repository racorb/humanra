            ...
            <li>
              <form class="form-inline mr-auto">
                <div class="search-element">
                  <input class="form-control" type="text" placeholder="Axtar" aria-label="Search" data-width="200" style="width: 200px;">
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
                                            text-white"> <img alt="image" src="{{asset('/')}}portal-html/assets/img/users/user-1.png" class="rounded-circle">
                    ...
                    <img alt="image" src="{{asset('/')}}portal-html/assets/img/users/user-2.png" class="rounded-circle">
                    ...
                    <img alt="image" src="{{asset('/')}}portal-html/assets/img/users/user-5.png" class="rounded-circle">
                </span> <span class="dropdown-item-desc"> <span class="message-user">Jacob
                    Ryan</span> <span class="time messege-text">Your payment invoice is
                    generated.</span> <span class="time">12 Min Ago</span>
                </span>
                </a> <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
                    <img alt="image" src="{{asset('/')}}portal-html/assets/img/users/user-4.png" class="rounded-circle">
                    ...
                    <img alt="image" src="{{asset('/')}}portal-html/assets/img/users/user-3.png" class="rounded-circle">
