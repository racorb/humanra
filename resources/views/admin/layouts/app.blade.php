<!DOCTYPE html>
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="{{asset('/')}}admin-html/assets/" data-template="vertical-menu-template-free">
  <head>
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="{{asset('/')}}admin-html/assets/vendor/libs/apex-charts/apex-charts.css" />
  ...
  <body>
    ...
    <!-- Vendors JS -->
    <script src="{{asset('/')}}admin-html/assets/vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="{{asset('/')}}admin-html/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="{{asset('/')}}admin-html/assets/js/dashboards-analytics.js"></script>
