...
<div class="col-12 col-xl-6">
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Edit Business Area</h5>
        </div>
        <div class="card-body">
            <form method="post" action="{{ route('admin.business.area.update', $business->id) }}">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary">Update Business Area</button>
            </form>
        </div>
    </div>
</div>
